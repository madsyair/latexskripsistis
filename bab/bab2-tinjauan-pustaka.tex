...
\emph{Cara menulis bab ini.} Bab Tinjauan Pustaka memuat landasan teori dan penelitian terkait yang menjadi dasar penelitian. Susun dari teori umum ke khusus dan tunjukkan kesenjangan yang diisi penelitian Anda.


\section{Landasan Teori}
\emph{Cara menulis.} Sajikan konsep dan teori utama yang menjadi dasar penelitian secara terstruktur (dari umum ke khusus). Setiap teori wajib bersumber dan relevan dengan masalah.
...
\emph{Cara menulis.} Tinjau penelitian terdahulu yang relevan (metode, data, temuan), tunjukkan kesenjangan yang belum terjawab, dan posisikan penelitian Anda.
...
\emph{Cara menulis.} Bagian ini hanya contoh teknis pengutipan (APA~7 modifikasi Indonesia); pada skripsi nyata, kaidah pengutipan menyatu di Landasan Teori/Penelitian Terkait dan subbab contoh ini dihapus.
...
\subsection{Contoh Perujukan Berbagai Jenis Sumber}
Setiap entri yang muncul pada Daftar Pustaka \textbf{harus} berasal dari sitasi di
dalam naskah (tidak boleh ada entri yang tidak dirujuk). Berikut contoh perujukan
jenis-jenis sumber yang lazim pada skripsi bidang kuantitatif (statistika,
matematika, ekonomi, ilmu komputer, informatika, kependudukan): buku teks
\parencite{cochran1991}; artikel jurnal \parencite{megawati2021,taufiq2021};
artikel jurnal ber-DOI \parencite{etang2022}; bab dalam buku \parencite{satu2023};
prosiding seminar \parencite{santoso2022}; skripsi terdahulu
\parencite{nugraha2024}; artikel surat kabar \parencite{karyadi2009}; publikasi
lembaga \parencite{bps2024}; laporan direktorat kementerian
\parencite{ditjenpdp2023}; sumber daring/situs web \parencite{worldbank2023};
dataset \parencite{bpssusenas2023}; pracetak (\emph{preprint}/arXiv)
\parencite{wang2023}; perangkat lunak/paket statistik \parencite{rcore2024}; serta
makalah kerja (\emph{working paper}) \parencite{ferreira2022}.
